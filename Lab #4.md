...
Problem Set #2
	...
	3.	distance=0.1720779
	vegdist(PresencePBDB[c(“Pleistocene”,”Miocene”),],method=“jaccard”)

    4.	vegdist(PresencePBDB[c("Pleistocene","Pliocene","Miocene","Oligocene","Eocene",
	"Paleocene"),],method="jaccard")
	       ...
	       Paleocene  0.44444444 0.37914692 0.33333333 0.41042345 0.33385827
            ...
            The Paleocene and Pleistocene epochs are the most dissimilar because they have the greatest 
	distance.

Problem Set #3
	1.	RandomEpochs<-PresencePBDB[c("Pliocene","Oligocene","Paleocene","Early Cretaceous","Late Jurassic","Middle Jurassic"),]
    2.	vegdist(RandomEpochs,methods="jaccard")
